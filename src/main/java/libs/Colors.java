...
public class Colors {
    ...
    private static final Color[] LIGHT_COLORS = {Color.CYAN, Color.WHITE, Color.RED,
            Color.YELLOW, LIGHT_BLUE, Color.PINK, Color.MAGENTA, LIGHT_BROWN,
            YELLOW_GREEN, Color.GREEN, BROWN, Color.LIGHT_GRAY, Color.ORANGE};

    private static final Color[] DARK_COLORS = {Color.BLACK, Color.BLUE, Color.DARK_GRAY, DARK_CYAN,
            VIOLET, DARK_ORANGE, Color.GRAY, DARK_GREEN};

    private static final float[][] OPEN_GL_COLORS = {{0f, 1f, 1f}, {1f, 1f, 1f}, {1f, 0f, 0f},
            {1f, 1f, 0f}, {45f, 0.45f, 1f}, {0.6f, 0f, 0f}, {1f, 0f, 1f}, {0.91f, 0.4f, 0.4f},
            {0.53f, 0.608f, 0.824f}, {0f, 1f, 0f}, {0.557f, 0.98f, 0.98f}
    };

    public static Function<Integer, Color> getDarkColor =  index
            -> DARK_COLORS[index % (DARK_COLORS.length - 1)];

    public static Function<Integer, Color> getLightColor = index -> LIGHT_COLORS[index % (LIGHT_COLORS.length - 1)];

    public static Function<Integer, Color> getColor = index-> {
