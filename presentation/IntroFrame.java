...
public class IntroFrame extends javax.swing.JFrame {
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        gameScreen.setDrawOutput(graphics);
    ...
    private Board createBoardBasedOnSelectedUiItems() throws NumberFormatException {
        ...
        if (selectedTrack.equals(rectTrackType.toString())) {
            result = Mocks.createBoardWithNVehiclesOnTrack(numberOfVehicles, Mocks.TrackType.RECTANGULAR_1);

        } else// if (selectedTrack.equals(CIRCULAR_TRACK))
        {
            result = Mocks.createBoardWithNVehiclesOnTrack(numberOfVehicles, Mocks.TrackType.CIRCULAR_1);
        }
        return result;
    }

    private IGraphicalOutput createGraphicalOutputBasedOnSelectedUiItems() {
        ...
        if (selectedGraphics.equals("2D")) {
            ...
            graphics = new Draw3d(gameScreen.getPnlBoard());
        }
        return graphics;
    }
